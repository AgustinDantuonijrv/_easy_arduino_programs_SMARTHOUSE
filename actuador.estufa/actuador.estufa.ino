...
//    WIFI
#define _SSID "Domotica"  //Estudiantes Speedy-Fibra-
#define _PASSWORD "proyecto" //educar_2018 12345678
...
void loop() {
  ...
  int Estado = Firebase.getInt ("users/Estados/agusdantuoni25/SpinnActuadores/a4/rele de estado solido(estufa)");
